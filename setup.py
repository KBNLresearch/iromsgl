...
setup(name='iromsgl',
      ...
      platforms=['Windows'],
      description='Image and Rip Optical Media Like A Boss (but without a disc robot)',
      long_description='Automated imaging of optical media',
      author='Johan van der Knijff',
      author_email='johan.vanderknijff@kb.nl',
      maintainer='Johan van der Knijff',
      maintainer_email='johan.vanderknijff@kb.nl',
      url='https://github.com/KBNLresearch/iromsgl',
      download_url=('https://github.com/KBNLresearch/iromsgl/archive/' +
